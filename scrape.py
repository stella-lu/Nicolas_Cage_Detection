...
def main():
    ...
    parser.add_argument('-s', '--search', default='Nicolas Cage', type=str, help='search term')
    parser.add_argument('-n', '--num_images', default=200, type=int, help='num images to save')
    parser.add_argument('-d', '--directory', default='/Users/Cactus/ObjectDetection-master/images', type=str, help='save directory')
